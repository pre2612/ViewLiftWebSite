 ...
 */
add_filter( 'seed_cspv4_enable_wp_head_footer_list', 'seed_cspv4_drip_enable_wp_head_footer_drip' );

function seed_cspv4_drip_enable_wp_head_footer_drip( $arr ) {
    $arr[] = 'drip';
...
if ( $seed_cspv4['emaillist'] == 'drip' ) {
    add_filter( 'redux/options/seed_cspv4/sections', 'seed_cspv4_drip_section' );
}
...
add_action( 'redux/options/seed_cspv4/saved', 'seed_csvp4_refresh_drip_lists' );
...
function seed_csvp4_refresh_drip_lists( $value ) {
    if ( ! empty( $value['refresh_drip'] ) && $value['refresh_drip'] == '1' ) {
        ...
        $seed_cspv4_reduxConfig->ReduxFramework->set( 'refresh_drip', 0 );
    }
